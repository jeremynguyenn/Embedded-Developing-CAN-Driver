...
Src/%.o Src/%.su: ../Src/%.c Src/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DDEBUG -DSTM32F446xx -c -I../Inc -I"C:/Users/user/Documents/CANBus-GroundUp/3_f44_can_normal-mode_rx/chip_headers/CMSIS/Include" -I"C:/Users/user/Documents/CANBus-GroundUp/3_f44_can_normal-mode_rx/chip_headers/CMSIS/Device/ST/STM32F4xx/Include" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@"
